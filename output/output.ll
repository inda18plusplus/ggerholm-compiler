...
@"number_fmt" = internal constant [4 x i8] c"%i\0a\00"
...
entry:
  %"x.1" = alloca i64
  store i64 %"x", i64* %"x.1"
  %".4" = bitcast [4 x i8]* @"number_fmt" to i8*
...
entry:
  ...
  %"y.1" = alloca i64
  store i64 %"y", i64* %"y.1"
  %".6" = bitcast [4 x i8]* @"number_fmt" to i8*
...
then:
  %".16" = bitcast [4 x i8]* @"number_fmt" to i8*
  %".17" = call i64 (i8*, ...) @"printf"(i8* %".16", i64 500000)
  br label %"after_if"
else:
  %"x.4" = load i64, i64* %"x.1"
...
after_if:
  ...
  %".22" = bitcast [4 x i8]* @"number_fmt" to i8*
...
then:
  %".6" = call i64 @"func"(i64 50)
  br label %"after_if"
else:
  %".8" = call i64 @"second"(i64 5, i64 2)
  %".9" = bitcast [4 x i8]* @"number_fmt" to i8*
  %".10" = call i64 (i8*, ...) @"printf"(i8* %".9", i64 3)
  br label %"after_if"
after_if:
  %"if_phi" = phi i64 [%".6", %"then"], [%".10", %"else"]
  %".12" = bitcast [4 x i8]* @"number_fmt" to i8*
  %".13" = mul i64 2, 6
  %".14" = call i64 (i8*, ...) @"printf"(i8* %".12", i64 %".13")
  %"i" = alloca i64
  store i64 2, i64* %"i"
  br label %"loop"
loop:
  %".17" = bitcast [4 x i8]* @"number_fmt" to i8*
  %"i.1" = load i64, i64* %"i"
